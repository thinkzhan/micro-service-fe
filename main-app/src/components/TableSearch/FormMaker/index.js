        ...
        const components = config.data.map(item => {
            ...
            return h(
                ...
                [
                        ...
                        getComponentName(item.type),
                        {
                            ...
                            on: {
                                input(v) {
                                    ...
                                    item.onChange &&
                                        item.onChange(self.formModel, item);
                    ...
                    // textarea 输入中字数提示
                    item.type === 'textarea' && item.maxLength
                        ? h('span', {
                              style: {
                                  marginLeft: '20px'
                              },
                              domProps: {
                                  innerHTML: `${
                                      self.formModel[item['model']].length
                                  }/${item.maxLength}`
                              }
                          })
                        : null,
                    item.tip
                        ? h('span', {
                              ...
                              domProps: {
                                  innerHTML:
                                      typeof item.tip === 'function'
                                          ? item.tip(self.formModel)
                                          : item.tip
                              }
                          })
                        : null
